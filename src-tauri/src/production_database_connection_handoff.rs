...
pub(crate) use create_new_database::{
    ...
    ClosedIntegrityValidatedInitializedNewProductionDatabase, CompletedFirstTimeSetupOperation,
    ...
    FirstTimeSetupActiveDatabaseOpenError, FirstTimeSetupActiveTrustMaterialPreparationError,
    FirstTimeSetupApplicationRootPreparationError,
    FirstTimeSetupAuthenticatedEvidencePublicationError,
    FirstTimeSetupAuthenticatedFreshnessAnchorPublicationError,
    FirstTimeSetupCanonicalInstallationObservationError, FirstTimeSetupDatabaseKeyPublicationError,
    ...
    FirstTimeSetupProtectedArtifactStagingError, FirstTimeSetupReadyForCompletionError,
    ...
    PreparedFirstTimeSetupApplicationRoot, PreparedFirstTimeSetupProtectedArtifactDirectories,
    ...
    compare_current_canonical_database_identity, complete_first_time_setup,
