...
pub(crate) use create_new_database::{
    ...
    ReadyForSetupCompletionFirstTimeSetupOperation, SetupDatabaseIdentityProof,
    SetupProductionDatabaseOpenError, ValidatedInitializedNewProductionDatabaseConnection,
