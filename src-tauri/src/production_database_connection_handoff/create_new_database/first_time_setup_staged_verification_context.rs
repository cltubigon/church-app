...
pub(crate) use protected_artifact_staging_operation::{
    ...
    FirstTimeSetupActiveTrustMaterialPreparationError,
    ...
    PreparedFinalActiveSetupTrustMaterial, PreparedFirstTimeSetupActivePublicationOperation,
    StagedVerificationCompletedFirstTimeSetupOperation, prepare_final_active_setup_trust_material,
